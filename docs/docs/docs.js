...
$('#Start').click(function() {
    if ($(this).text() == 'Get Started') {
       ...
       $("#Sprite").toggle('fast');
        ...
        $('.container4').toggle('fast');
        $('.container5').toggle('fast');
        if ($('#typelist').is(':visible') && $(this).text() == 'Get Started') {
          $('#typelist').hide();
          $('#startlist').hide();
       }
...
//TYPE ANIMATION
$('#Type').click(function() {
    if ($(this).text() == ' Woof by typing along below. ') {
