...
function Polygon(t, o) {
  ;(this.pos =
    t ||
    new Vector()), (this.angle = 0), (this.offset = new Vector()), this.setPoints(
    o || []
  )
}
function Box(t, o, e) {
...
function flattenPointsOn(t, o, e) {
  for (
    var r = Number.MAX_VALUE, n = -Number.MAX_VALUE, s = t.length, i = 0;
    s > i;
    i++
  ) {
    var p = t[i].dot(o)
...
function isSeparatingAxis(t, o, e, r, n, s) {
  ...
  if (
    (
      flattenPointsOn(e, n, i),
      flattenPointsOn(r, n, p),
      (p[0] += l),
      (p[1] += l),
      i[0] > p[1] || p[0] > i[1]
    )
  )
    return T_VECTORS.push(c), T_ARRAYS.push(i), T_ARRAYS.push(p), !0
  if (s) {
    var h = 0
    if (i[0] < p[0])
      if (((s.aInB = !1), i[1] < p[1])) (h = i[1] - p[0]), (s.bInA = !1)
      else {
        var a = i[1] - p[0],
          y = p[1] - i[0]
        h = y > a ? a : -y
      }
    else if (((s.bInA = !1), i[1] > p[1])) (h = i[0] - p[1]), (s.aInB = !1)
    else {
      var a = i[1] - p[0],
        y = p[1] - i[0]
      h = y > a ? a : -y
    ...
    var u = Math.abs(h)
    u < s.overlap &&
      ((s.overlap = u), s.overlapN.copy(n), 0 > h && s.overlapN.reverse())
  }
...
function voronoiRegion(t, o) {
  ...
  return 0 > r
    ? LEFT_VORONOI_REGION
    : r > e ? RIGHT_VORONOI_REGION : MIDDLE_VORONOI_REGION
}
...
function testCircleCircle(t, o, e) {
  ...
  if (e) {
    var p = Math.sqrt(i)
    ;(e.a = t), (e.b = o), (e.overlap = n - p), e.overlapN.copy(
      r.normalize()
    ), e.overlapV.copy(r).scale(e.overlap), (e.aInB =
      t.r <= o.r && p <= o.r - t.r), (e.bInA = o.r <= t.r && p <= t.r - o.r)
  }
  ...
  for (
    ...
    if (T === LEFT_VORONOI_REGION) {
      ...
      if (((T = voronoiRegion(c, f)), T === RIGHT_VORONOI_REGION)) {
        var R = l.len()
        if (R > n)
          return T_VECTORS.push(r), T_VECTORS.push(c), T_VECTORS.push(
            l
          ), T_VECTORS.push(f), !1
      ...
      if (
        (
          ...
          l.copy(r).sub(i[a]),
          (T = voronoiRegion(c, l)),
          T === LEFT_VORONOI_REGION
        )
      ) {
        var R = l.len()
        if (R > n)
          return T_VECTORS.push(r), T_VECTORS.push(c), T_VECTORS.push(l), !1
        e && ((e.bInA = !1), (V = l.normalize()), (u = n - R))
      }
    } else {
      var O = c.perp().normalize(),
        ...
        v = Math.abs(R)
      if (R > 0 && v > n)
        return T_VECTORS.push(r), T_VECTORS.push(O), T_VECTORS.push(l), !1
      e && ((V = O), (u = n - R), (R >= 0 || 2 * n > u) && (e.bInA = !1))
    }
    V &&
      e &&
      Math.abs(u) < Math.abs(e.overlap) &&
      ((e.overlap = u), e.overlapN.copy(V))
  }
  return e &&
    (
      (e.a = t),
    ...
    ), T_VECTORS.push(r), T_VECTORS.push(c), T_VECTORS.push(l), !0
}
function testCirclePolygon(t, o, e) {
  ...
  if (r && e) {
    var n = e.a,
      s = e.aInB
    e.overlapN.reverse(), e.overlapV.reverse(), (e.a =
      e.b), (e.b = n), (e.aInB = e.bInA), (e.bInA = s)
  }
  return r
}
function testPolygonPolygon(t, o, e) {
  for (
    var r = t.calcPoints, n = r.length, s = o.calcPoints, i = s.length, p = 0;
    n > p;
    p++
  )
  ...
  return e &&
    ((e.a = t), (e.b = o), e.overlapV.copy(e.overlapN).scale(e.overlap)), !0
}
var SAT = {}
;(SAT.Vector = Vector), (SAT.V = Vector), (Vector.prototype.copy = Vector.prototype.copy = function(
  t
) {
  ...
  var o = this.x,
    e = this.y
  return (this.x = o * Math.cos(t) - e * Math.sin(t)), (this.y =
    o * Math.sin(t) + e * Math.cos(t)), this
...
}), (SAT.Polygon = Polygon), (Polygon.prototype.setPoints = Polygon.prototype.setPoints = function(
  t
) {
  ...
  for (var o = this.points, e = o.length, r = 0; e > r; r++) o[r].rotate(t)
  ...
  for (t = 0; p > t; t++) {
    var c = o[t].copy(n[t])
    ;(c.x += s.x), (c.y += s.y), 0 !== i && c.rotate(i)
  }
  for (t = 0; p > t; t++) {
    var l = o[t],
      h = p - 1 > t ? o[t + 1] : o[0],
  ...
  for (
    ...
    var p = t[i]
    p.x < e ? (e = p.x) : p.x > n && (n = p.x), p.y < r
      ? (r = p.y)
      : p.y > s && (s = p.y)
  }
  return new Box(
    this.pos.clone().add(new Vector(e, r)),
    n - e,
    s - r
  ).toPolygon()
  ...
  var t = this.pos,
    o = this.w,
    e = this.h
  return new Polygon(new Vector(t.x, t.y), [
    new Vector(),
    new Vector(o, 0),
    new Vector(o, e),
    new Vector(0, e),
  ...
  return (this.aInB = !0), (this.bInA = !0), (this.overlap =
    Number.MAX_VALUE), this
})
for (var T_VECTORS = [], i = 0; 10 > i; i++) T_VECTORS.push(new Vector())
for (var T_ARRAYS = [], i = 0; 5 > i; i++) T_ARRAYS.push([])
...
;(SAT.pointInCircle = pointInCircle), (SAT.pointInPolygon = pointInPolygon), (SAT.testCircleCircle = testCircleCircle), (SAT.testPolygonCircle = testPolygonCircle), (SAT.testCirclePolygon = testCirclePolygon), (SAT.testPolygonPolygon = testPolygonPolygon)
...
function Woof(
  {global = false, fullScreen = false, height = 500, width = 350} = {}
) {
  if (window.global)
    throw new Error(
      "You must turn off global mode in the Woof script tag if you want to create your own Woof object."
    )
  this.global = global
  ...
  thisContext._runReadys = () => {
    ...
    thisContext._readys.forEach(func => {
      func()
    })
    thisContext._readys = []
  }
  ...
  thisContext.setBackdropSize = (width, height) => {
    if (typeof width != "number" || typeof height != "number") {
      throw new TypeError(
        "setBackdropSize(width, height) requires two number inputs."
      )
    }
    if (thisContext.fullScreen1) {
      throw Error(
        "You cannot manually set the backdrop size in full-screen mode. You can full-screen mode off with: fullScreen = false."
      )
    } else {
  ...
  thisContext._renderBackdrop = () => {
    ...
    thisContext._backdropDiv.style.background =
      type === "url" ? `url('${url}')` : color
  ...
  thisContext.setBackdropStyle = function(coverOrContain) {
    ...
    if (coverOrContain.length > 2) {
      throw Error(
        "setBackdropStyle can take one or two arguments, separated by a space."
      )
    }
    ...
    if (
      !coverOrContain.every(prop =>
        acceptableSizes.some(each => prop.match(each))
      )
    ) {
      throw Error(
        "setBackdropStyle only understands sizes such as 5em, 50px, 50% and the keywords cover, contain, and auto"
      )
    }
  ...
  thisContext.setBackdropRepeat = function(repeatString) {
    ...
    if (!acceptableValues.includes(repeatString)) {
      throw Error(
        `setBackdropRepeat can only understand one of the following: ${acceptableValues.join(
          ", "
        )}`
      )
    }
  ...
  thisContext.translateToCenter = (x, y) => {
    return [
      x -
        thisContext.width / 2 +
        thisContext.cameraX -
        thisContext._spriteCanvas.offsetLeft,
      thisContext.height / 2 -
        y +
        thisContext.cameraY +
        thisContext._spriteCanvas.offsetTop,
    ]
  }
  ...
  thisContext.translateToCanvas = (x, y) => {
    return [
      x + thisContext.maxX - thisContext._spriteCanvas.offsetLeft,
      thisContext.maxY - y + thisContext._spriteCanvas.offsetTop,
    ]
  }
  ...
  thisContext.ready(() => {
    thisContext._spriteCanvas.addEventListener("mousedown", event => {
      ...
      ;[thisContext.mouseX, thisContext.mouseY] = thisContext.translateToCenter(
        event.clientX,
        event.clientY
      )
    })
    ...
    thisContext._onMouseMoveHandler = event => {
      var [mouseX, mouseY] = thisContext.translateToCenter(
        event.clientX,
        event.clientY
      )
      thisContext._onMouseMoves.forEach(func => {
        func(mouseX, mouseY)
      })
    }
    thisContext._spriteCanvas.addEventListener(
      "mousemove",
      thisContext._onMouseMoveHandler
    )
    thisContext._onMouseDownHandler = event => {
      ...
      thisContext._onMouseDowns.forEach(func => {
        func(mouseX, mouseY)
      })
    }
    thisContext._spriteCanvas.addEventListener(
      "mousedown",
      thisContext._onMouseDownHandler
    )
    thisContext._onMouseUpHandler = event => {
      ...
      thisContext._onMouseUps.forEach(func => {
        func(mouseX, mouseY)
      })
    }
    thisContext._spriteCanvas.addEventListener(
      "mouseup",
      thisContext._onMouseUpHandler
    )

    thisContext._onKeyDownHandler = event => {
      var key = Woof.prototype.keyCodeToString(event.keyCode)
      thisContext._onKeyDowns.forEach(func => {
        func(key)
      })
    }
    ...
    thisContext._onKeyUpHandler = event => {
      var key = Woof.prototype.keyCodeToString(event.keyCode)
      thisContext._onKeyUps.forEach(func => {
        func(key)
      })
    }
  ...
  thisContext.every = (time, units, func) => {
    if (
      ...
      (typeof time != "number" && typeof time != "function")
    ) {
      throw new TypeError(
        "every(time, units, function) requires a number/function, time unit and function input."
      )
    }
    ...
    if (typeof time == "function") {
      if (typeof time() != "number") {
        throw new TypeError(
          "every(time, units, function) requires a time function that returns a number"
        )
      }
      ...
      var theFunction = function(timeoutValue) {
        ...
        if (timeoutValue && thisContext._everys.includes(timeoutValue)) {
          thisContext._everys.splice(
            thisContext._everys.indexOf(timeoutValue),
            1
          )
        }
  ...
  thisContext.when = (condition, func) => {
    if (typeof func != "function" || typeof condition != "function") {
      throw new TypeError(
        "when(conditionFunction, function) requires two function inputs."
      )
    }
    thisContext.forever(() => {
      var cond
      try {
        ...
        console.error(
          "Bad condition in when(conditionFunction, function): " + condition
        )
        throw e
      }
      if (cond) {
  ...
  thisContext.repeat = (times, func, after) => {
    if (
      ...
      throw new TypeError(
        "repeat(times, function, afterFunction) requires a number and a function, and optionally accepts an extra function."
      )
    }
  ...
  thisContext.repeatUntil = (condition, func, after) => {
    if (
      ...
      throw new TypeError(
        "repeatUntil(conditionFunction, function, afterFunction) requires two functions, and optionally accepts an extra function."
      )
    }
    thisContext._repeats.push(
      new Woof.prototype.RepeatUntil(condition, func, after)
    )
  }
  thisContext._runRepeats = () => {
    ...
    thisContext._repeats = thisContext._repeats.filter(repeat => {
      return !repeat.done
    })
  }
  ...
  thisContext.after = (time, units, func) => {
    ...
    if (typeof func != "function" || typeof time != "number") {
      throw new TypeError(
        "after(time, units, function) requires a number, unit and function input."
      )
    }
  ...
  thisContext._renderSprites = () => {
    thisContext._spriteContext.clearRect(
      0,
      0,
      thisContext.width,
      thisContext.height
  ...
  thisContext.clearPen = function() {
    ...
    thisContext._penContext.clearRect(
      0,
      0,
      thisContext.width,
      thisContext.height
  ...
  thisContext._calculateMouseSpeed = () => {
    ...
    ;[thisContext.pMouseX, thisContext.pMouseY] = [
      thisContext.mouseX,
      thisContext.mouseY,
    ]
  }
  ...
  thisContext._render = () => {
    ...
    thisContext._calculateMouseSpeed()
    thisContext.renderInterval = window.requestAnimationFrame(
      thisContext._render
    ) // WARNING this line makes render recursive. Only call is once and it will continue to call itself ~30fps.
    if (thisContext.stopped) {
      return
    }
    thisContext._renderSprites()
...
Woof.prototype.Sprite = function(
  ...
  if (!project) {
    if (global) {
      ...
      throw new TypeError(
        "When not in global mode, you must supply your {project: project} to each Sprite."
      )
    }
  } else {
  ...
  this.trackPen = () => {
    if (this._penDown) {
      if (this.lastX != this.x || this.lastY != this.y) {
        ...
        this.project._penContext.moveTo(
          ...this.project.translateToCanvas(this.lastX, this.lastY)
        )
        this.project._penContext.lineTo(
          ...this.project.translateToCanvas(this.x, this.y)
        )
  ...
  this.rotatedVector = function(x, y) {
    ...
    if (this.type == "line") {
      rotatedX =
        Math.cos(this.radians()) * (x - this.x) -
        Math.sin(this.radians()) * (y - this.y + this.height / 2) +
        this.x
      rotatedY =
        Math.sin(this.radians()) * (x - this.x) +
        Math.cos(this.radians()) * (y - this.y + this.height / 2) +
        this.y
    } else {
      rotatedX =
        Math.cos(this.radians()) * (x - this.x) -
        Math.sin(this.radians()) * (y - this.y) +
        this.x
      rotatedY =
        Math.sin(this.radians()) * (x - this.x) +
        Math.cos(this.radians()) * (y - this.y) +
        this.y
    }
  ...
  this.collider = function() {
    var pos = this.rotatedVector(
      this.x - this.width / 2,
      this.y - this.height / 2
    )
    var v1 = new SAT.Vector(0, 0)
    var v2 = this.translatedVector(
      pos,
      this.rotatedVector(this.x + this.width / 2, this.y - this.height / 2)
    )
    var v3 = this.translatedVector(
      pos,
      this.rotatedVector(this.x + this.width / 2, this.y + this.height / 2)
    )
    var v4 = this.translatedVector(
      pos,
      this.rotatedVector(this.x - this.width / 2, this.y + this.height / 2)
    )
  ...
  this._renderCollider = function(context) {
    ...
    context.beginPath()
    context.moveTo(
      ...this.project.translateToCanvas(
        collider.calcPoints[0].x + collider.pos.x,
        collider.calcPoints[0].y + collider.pos.y
      )
    )
    context.lineTo(
      ...this.project.translateToCanvas(
        collider.calcPoints[1].x + collider.pos.x,
        collider.calcPoints[1].y + collider.pos.y
      )
    )
    context.lineTo(
      ...this.project.translateToCanvas(
        collider.calcPoints[2].x + collider.pos.x,
        collider.calcPoints[2].y + collider.pos.y
      )
    )
    context.lineTo(
      ...this.project.translateToCanvas(
        collider.calcPoints[3].x + collider.pos.x,
        collider.calcPoints[3].y + collider.pos.y
      )
    )
    context.lineTo(
      ...this.project.translateToCanvas(
  ...
  this.touching = (sprite, precise) => {
    ...
    if (!detectCollision(this.collider(), sprite.collider())) {
      return false
    }
    ...
    try {
      var data = this.collisionContext.getImageData(
        canvasLeft,
        canvasTop,
        right - left,
        top - bottom
      ...
      if (e instanceof DOMException) {
        console.warn(
          "You have an image at an untrusted URL. Consider uploading to Imgur and using https."
        )
  ...
  this.sendToFront = function() {
    ...
    sprites.splice(
      sprites.length,
      0,
      sprites.splice(sprites.indexOf(this), 1)[0]
    )
  }
  ...
  this._onMouseDownHandler = event => {
    var [mouseX, mouseY] = this.project.translateToCenter(
      event.clientX,
      event.clientY
    )
  ...
  this.project.ready(() => {
    this.project._spriteCanvas.addEventListener(
      "mousedown",
  ...
  this.delete = function() {
    ...
    if (this.project.sprites.includes(this)) {
      ...
      this.project._spriteCanvas.removeEventListener(
        "mousedown",
...
Woof.prototype.Text = function(
  ...
  Object.defineProperty(this, "width", {
    ...
    set: function(value) {
      throw new TypeError(
        "You cannot modify the width of Text. You can only change its size."
      )
    },
  })
  ...
  Object.defineProperty(this, "height", {
    ...
    set: function(value) {
      throw new TypeError(
        "You cannot modify the height of Text. You can only change its size."
      )
    },
  })
...
Woof.prototype.Circle = function(
  {project = undefined, radius = 10, color = "black"} = {}
) {
  this.type = "circle"
  Woof.prototype.Sprite.call(this, arguments[0])
  ...
  Object.defineProperty(this, "width", {
    ...
    set: function(value) {
      throw new TypeError(
        "You cannot modify the width of Circle. You can only change its radius."
      )
    },
  })
  ...
  Object.defineProperty(this, "height", {
    ...
    set: function(value) {
      throw new TypeError(
        "You cannot modify the height of Circle. You can only change its radius."
      )
    },
  })
...
Woof.prototype.Rectangle = function(
  {project = undefined, height = 10, width = 10, color = "black"} = {}
) {
  this.type = "rectangle"
  Woof.prototype.Sprite.call(this, arguments[0])
...
Woof.prototype.Oval = function(
  {project = undefined, height = 50, width = 20, color = "green"} = {}
) {
  this.type = "oval"
  Woof.prototype.Sprite.call(this, arguments[0])
...
Woof.prototype.Polygon = function(
  {project = undefined, sides = 3, length = 100, color = "black"} = {}
) {
  this.type = "polygon"
  Woof.prototype.Sprite.call(this, arguments[0])
  ...
  Object.defineProperty(this, "sides", {
    ...
    set: function(value) {
      if (typeof value != "number" || value < 3) {
        throw new TypeError(
          "polygon.sides can only be set to a number that is greater than or equal to 3."
        )
      }
  ...
  this.collider = function() {
    ...
    var v2 = this.translatedVector(
      pos,
      this.rotatedVector(this.x + this.length, this.y - this.length)
    )
    var v3 = this.translatedVector(
      pos,
      this.rotatedVector(this.x + this.length, this.y + this.length)
  ...
  this.render = context => {
    ...
    for (i = 1; i < sides; i++) {
      context.lineTo(
        length * Math.cos(i * (2 * Math.PI / sides)),
        length * Math.sin(i * (2 * Math.PI / sides))
      )
    }
    context.fill()
  }
...
Woof.prototype.Line = function(
  {project = undefined, width = 1, x1 = 10, y1 = 10, color = "black"} = {}
) {
  this.type = "line"
  Woof.prototype.Sprite.call(this, arguments[0])
  this.x1 = x1
  ...
  Object.defineProperty(this, "height", {
    ...
    set: function(value) {
      throw new TypeError(
        "You cannot set line.height directly. You can only modify line.height by changing the length of your line through moving its points."
      )
    },
  })
  ...
  Object.defineProperty(this, "angle", {
    get: function() {
      return (
        Math.atan2(-this.x1 + this.x, this.y1 - this.y) * 180 / Math.PI + 90
      )
    },
    set: function(value) {
      throw new TypeError(
        "You cannot set line.angle directly. You can only modify line.angle by changing the position of the line's points."
      )
    },
  })
  ...
  this.move = function() {
    throw new TypeError(
      "You cannot move lines with move() unfortunately! Change the x, y, x1, and y1 values instead."
    )
  }
...
Woof.prototype.Image = function(
  {project = undefined, url = "./images/SMJjVCL.png", height, width} = {}
) {
  this.type = "image"
  Woof.prototype.Sprite.call(this, arguments[0])
...
Woof.prototype.random = function(a, b) {
  ...
  return (
    Math.round(rand * Math.pow(10, randDecimals)) / Math.pow(10, randDecimals)
  )
}
...
function throttle(callback, limit) {
  if (typeof callback != "function" || typeof limit != "number") {
    throw new TypeError(
      "throttle(function, limit) requires one function input and one number."
    )
  }
  var wait = false
  return function() {
